...
case class CartItem(id: Int, productId: Int, orderId: Int, amount: Int, typename: String)
object CartItem {
...
case class CartItemREST(productId: Int, orderId: Int, amount: Int, typename: String)
object CartItemREST {
